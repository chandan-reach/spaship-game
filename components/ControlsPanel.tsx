...
import { XCircleIcon, TerraformIcon, AdjustmentsIcon, SparklesIcon, SaveIcon, LoadIcon } from './Icons';
...
const ShipConfigPanel: React.FC = () => {
    const { shipConfig, handleShipConfigChange, addShipModulation, updateShipModulation, removeShipModulation, handleSaveShipConfig, handleLoadShipConfig } = useAppContext();

    return (
        <div className="space-y-6">
            <div className="flex gap-2 mb-4">
                 <button onClick={handleSaveShipConfig} className="flex-1 flex items-center justify-center gap-2 px-3 py-2 bg-gray-800 hover:bg-gray-700 border border-gray-600 text-white font-semibold text-xs rounded-md transition-colors" title="Save Ship Configuration">
                     <SaveIcon className="w-4 h-4" /> Export Ship
                 </button>
                 <button onClick={handleLoadShipConfig} className="flex-1 flex items-center justify-center gap-2 px-3 py-2 bg-gray-800 hover:bg-gray-700 border border-gray-600 text-white font-semibold text-xs rounded-md transition-colors" title="Load Ship Configuration">
                     <LoadIcon className="w-4 h-4" /> Import Ship
                 </button>
            </div>
