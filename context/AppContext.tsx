...
export interface AppContextType {
  ...
  // Ship Save/Load
  handleSaveShipConfig: () => void;
  handleLoadShipConfig: () => void;
  shipFileInputRef: RefObject<HTMLInputElement>;
  handleShipFileChange: (event: React.ChangeEvent<HTMLInputElement>) => void;
}
